...
select top 10 * from [distribution].[dbo].[MSdistribution_history] order by time desc; 
...
From <https://portal.bd.bluecrystal.com.au/cms/display/SAHEALTH/Tips+n+Tricks#TipsnTricks-SQLserver>  