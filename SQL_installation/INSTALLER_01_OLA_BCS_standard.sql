...
LAST UPDATED 02/02/2023 - Gennadi 
...
BEGIN
  ...
  SET @JobOwner = SUSER_SNAME(0x01)
   ...
   SET @JobName01 = @JobsPrefix + 'All DBs Full Database Backup'
   SET @JobName06 = @JobsPrefix + 'Users DBs DIFF Database Backup'
   SET @JobName04 = @JobsPrefix + 'Users DBs Transaction Log Backup'
   SET @JobName03 = @JobsPrefix + 'All DBs Integrity'
   SET @JobName02 = @JobsPrefix + 'SQL Server Errorlog Cycle'
   SET @JobName05 = @JobsPrefix + 'All DBs Optimisation'  
